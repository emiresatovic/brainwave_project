  ...
  return (
    <Section id='how-to-use'>
        <div className="container">
           <Heading title='Generative AI made for Creators' text='Brainwave unlocks potential of AI-powered applications' />
           <div className="relative">
            <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 lg:h-[46rem]">
            ...
            <div className="relative z-1 grid gap-5 lg:grid-cols-2">
               ...
               <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
                  ...
                  <div className="relative h-[20rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem]">
                    <img src={service3} className="w-full h-full object-cover" width={520} height={500} alt="sacry robot" />
                    <VideoChatMessage />
                    <VideoBar />
                  </div>
               </div>
